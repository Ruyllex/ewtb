...
// 🛑 CORRECCIÓN DE IMPORTACIÓN: Cambiamos 'useTRPC' por la importación de 'api'
// import { useTRPC } from "@/trpc/client";
import { api as trpc } from "@/trpc/client"; 
// 🛑 CORRECCIÓN DE IMPORTACIÓN: 'useInfiniteQuery' debe ser eliminado
...
  // 🛑 CORRECCIÓN: Eliminamos la inicialización obsoleta. 'trpc' ya está disponible vía import.
  // const trpc = useTRPC(); 
  
...
  // 🛑 CORRECCIÓN 1: Reemplazamos useInfiniteQuery(...) con trpc.videos.getPersonalFeed.useInfiniteQuery
  const {
...
  // 🛑 CORRECCIÓN 2: Reemplazamos useInfiniteQuery(...) con trpc.videos.getMany.useInfiniteQuery
  const {
...
  // 🛑 CORRECCIÓN 3: Reemplazamos useInfiniteQuery(...) con trpc.live.getPersonalFeed.useInfiniteQuery
  const {
...
  } = trpc.live.getPersonalFeed.useInfiniteQuery(
      { limit: 20 },
      {
        getNextPageParam: (lastPage) => lastPage.nextCursor,
        enabled: isSignedIn && activeTab === "personal",
...
  // 🛑 CORRECCIÓN 4: Reemplazamos useInfiniteQuery(...) con trpc.live.getPublicStreams.useInfiniteQuery
  const {
...
  } = trpc.live.getPublicStreams.useInfiniteQuery(
      { limit: 20 },
      {
        getNextPageParam: (lastPage) => lastPage.nextCursor,
        enabled: activeTab === "global",
