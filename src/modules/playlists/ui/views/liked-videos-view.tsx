...
export const LikedVideosView = () => {
  ...
  const {
    ...
    fetchNextPage,
    isLoading,
  } = trpc.playlists.getLiked.useInfiniteQuery(
    { limit: 20 },
    {
  ...
  if (!isSignedIn) {
    return (
      <div className="max-w-[2400px] mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-2">Videos que te gustan</h1>
        </div>
        <div className="text-center py-12 flex flex-col items-center">
          <ThumbsUpIcon className="size-16 text-muted-foreground/50 mb-4" />
          <p className="text-muted-foreground mb-6 text-lg">
            Inicia sesión para ver los videos que te han gustado.
          </p>
    ...
    <div className="max-w-[2400px] mx-auto px-4 py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Los videos que has marcado con "Me gusta" aparecerán aquí
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 flex flex-col items-center">
          <ThumbsUpIcon className="size-16 text-muted-foreground/50 mb-4" />
          <p className="text-muted-foreground mb-6 text-lg">
            Aún no has dado "Me gusta" a ningún video.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {videos.map((item) => (
              <VideoCard
                ...
                likes={item.likes}
                // viewCount={item.viewCount} // No está en la query de getLiked por ahora
